...
STOPWORDS = {"the","is","a","an","and","or","to","of","in","on","for","with","by","as","at",
            "from","that","this","it","be","are","was","were","will","can","into","over"}
...
class BM25Index:
    ...
    def _tokenize(self, texts):
        ...
        for text in texts:
            text = text.lower()
            tokens = [token for token in re.findall(r"[a-z0-9]+", text) 
    ...
    def search(self, query: str, k: int = 5):
        q = [x for x in re.findall(r"[a-z0-9]+", query.lower())
